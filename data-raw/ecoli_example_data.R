...
ecoli_afp_atb <- afp %>% filter(Name %in% ecoli_ast_ebi$id) %>% filter(drug_class %in% c("Quinolones","Trimethoprims","Sulfonamides", "Macrolides", "Macrolides/lincosamides", "Beta-lactams/penicillins", "Carbapenems", "Cephalosporins"))
